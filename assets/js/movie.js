(function($){
    ...
    (function handleTrailler() {
        // 셀렉터 캐시
        let $selector = {
            body : $("body"),
            overlay : $("#blackout"),
            modal : $("#trailerModal"),
            showButton : $("#showTrailler"),
            hideButton : $("#hideTrailler"),
        };
        ...
        function resizePlayer() {
            let viewport = {}, frame = {}, modal = {};
            
            viewport.width = $(window).width();
            viewport.height = $(window).height();

            frame.width = viewport.width;
            frame.height = frame.width / 1.6;     // 16 : 10으로 화면 조정
